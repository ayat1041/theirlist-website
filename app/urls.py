...
urlpatterns = [
    ...
    path('list/<int:pk>/', TheirDetailView.as_view(),name='list_detail'),
    path('booklist/<int:pk>/', TheirDetailBookView.as_view(),name='booklist_detail'),
    path('musiclist/<int:pk>/', TheirDetailMusicView.as_view(),name='musiclist_detail'),
